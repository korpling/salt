...
public class SaltCorePackageImpl extends EPackageImpl implements SaltCorePackage {
	 ...
	 * @see de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SaltCorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getSLayer_SSubLayers() {
		return (EReference)sLayerEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getSLayer_SSuperLayer() {
		return (EReference)sLayerEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEReference(sLayerEClass, SLAYER__SSUB_LAYERS);
		createEReference(sLayerEClass, SLAYER__SSUPER_LAYER);
	...
	public void initializePackageContents() {
		...
		addEParameter(op, ecorePackage.getEJavaObject(), "sValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSDATATYPE(), "sValueType", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(sFeaturableElementEClass, this.getSFeature(), "createSFeature", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "sNS", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "sName", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEJavaObject(), "sValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSDATATYPE(), "sValueType", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getSLayer_SSubLayers(), this.getSLayer(), this.getSLayer_SSuperLayer(), "sSubLayers", null, 0, -1, SLayer.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSLayer_SSuperLayer(), this.getSLayer(), this.getSLayer_SSubLayers(), "sSuperLayer", null, 0, 1, SLayer.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(sdatatypeEEnum, de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SDATATYPE.class, "SDATATYPE");
		addEEnumLiteral(sdatatypeEEnum, de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SDATATYPE.STEXT);
		addEEnumLiteral(sdatatypeEEnum, de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SDATATYPE.SBOOLEAN);
		addEEnumLiteral(sdatatypeEEnum, de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SDATATYPE.SNUMERIC);
		addEEnumLiteral(sdatatypeEEnum, de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SDATATYPE.SFLOAT);
		addEEnumLiteral(sdatatypeEEnum, de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SDATATYPE.SURI);
		addEEnumLiteral(sdatatypeEEnum, de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SDATATYPE.SOBJECT);
