 ...
 * <ul>
 *   <li>{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSTEXT() <em>Get SValue STEXT</em>}</li>
 *   <li>{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSBOOLEAN() <em>Get SValue SBOOLEAN</em>}</li>
 *   <li>{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSNUMERIC() <em>Get SValue SNUMERIC</em>}</li>
 *   <li>{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSFLOAT() <em>Get SValue SFLOAT</em>}</li>
 *   <li>{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSURI() <em>Get SValue SURI</em>}</li>
 *   <li>{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSOBJECT() <em>Get SValue SOBJECT</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public abstract class SAbstractAnnotationTest extends TestCase {
	...
	/**
	 * Tests the '{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSBOOLEAN() <em>Get SValue SBOOLEAN</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueSBOOLEAN()
	 */
	...
	/**
	 * Tests the '{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#getSValueType() <em>SValue Type</em>}' feature getter.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Tests the '{@link de.hub.corpling.salt.saltCore.SAbstractAnnotation#setSValueType(de.hub.corpling.salt.saltCore.SDATATYPES) <em>SValue Type</em>}' feature setter.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.hub.corpling.salt.saltCore.SAbstractAnnotation#setSValueType(de.hub.corpling.salt.saltCore.SDATATYPES)
	 */
