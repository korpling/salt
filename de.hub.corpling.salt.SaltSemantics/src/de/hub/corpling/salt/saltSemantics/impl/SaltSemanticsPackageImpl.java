...
public class SaltSemanticsPackageImpl extends EPackageImpl implements SaltSemanticsPackage {
	...
	public void initializePackageContents() {
		...
		initEEnum(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.class, "SALT_SEMANTIC_NAMES");
		addEEnumLiteral(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.POS);
		addEEnumLiteral(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.LEMMA);
		addEEnumLiteral(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.CAT);
		addEEnumLiteral(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.TYPE);
		addEEnumLiteral(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.TEXT_UNIT);
		addEEnumLiteral(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.TEXT_UNIT_WORD);
		addEEnumLiteral(salT_SEMANTIC_NAMESEEnum, de.hub.corpling.salt.saltSemantics.SALT_SEMANTIC_NAMES.TEXT_UNIT_SENTENCE);
