 ...
 * <ul>
 *   <li>{@link de.corpling.salt.model.saltCore.impl.SNamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
{
	private static final String MSG_ERR= "Error("+SNamedElementImpl.class+"): ";
	/**
	...
	public void setName(String newName) 
	{
		if ((newName== null) || (newName.equalsIgnoreCase("")))
			throw new NullPointerException(MSG_ERR + "Cannot set an empty name.");
		String oldName = name;
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SaltCorePackage.SNAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SaltCorePackage.SNAMED_ELEMENT__NAME:
				return getName();
		}
