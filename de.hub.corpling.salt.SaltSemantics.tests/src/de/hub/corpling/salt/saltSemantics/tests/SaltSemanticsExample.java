...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>saltSemantics</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SaltSemanticsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.saltsemantics"));
				SPOSAnnotation root = SaltSemanticsFactory.eINSTANCE.createSPOSAnnotation();
