...
import de.hub.corpling.salt.saltCommon.sDocumentStructure.STYPE_NAME;
...
// ========================================== end: encoding	
	...
	public void save()
	{
		...
		if (this.getsDocumentGraph().getSTextualDSs().size()> 1)
			throw new SaltException("Cannot save SDocumentGraph to GrAF-format, because more than one primary data layer is given.");
		...
		{//write buffer to file
			...
			{
				throw new SaltException("Cannot write to resource '"+this.getDestination()+"'. ",e);
	...
	private void saveSNodesAsNodesNSpans(EList<SNode> sNodes)
	{
		for (SNode sNode: sNodes)
		{
			...
			{//save SToken-object
				...
				if (sTextRel== null)
					throw new SaltException("Cannot export SDocument, because a STextualRelation-object is empty.");
...
//		this.outBuffer.append(this.edgeStringBuffer.toString());
	...
	private void saveSTokenAsSpan(SToken sToken, STextualRelation sTextRel)
	{
		...
		if (sTextRel== null)
			throw new SaltException("Cannot export document, because a STextualRelation is empty.");
	...
	private static final String KW_AE_BIG="Ä";
	private static final String KW_AE_BIG_XML= "&#196;";
	private static final String KW_OE_BIG="Ö";
	private static final String KW_OE_BIG_XML= "&#214;";
	private static final String KW_UE_BIG="Ü";
	private static final String KW_UE_BIG_XML= "&#220;";
	private static final String KW_AE="ä";
	private static final String KW_AE_XML= "&#228;";
	private static final String KW_OE="ö";
	private static final String KW_OE_XML= "&#246;";
	private static final String KW_UE="ü";
	private static final String KW_UE_XML= "&#252;";
	private static final String KW_SS="ß";
