...
import static org.corpus_tools.salt.util.traversal.ExcludeFilter.excludeSpans;
import static org.corpus_tools.salt.util.traversal.ExcludeFilter.excludeTokens;
import static org.corpus_tools.salt.util.traversal.ExcludeFilter.structures;
import static org.corpus_tools.salt.util.traversal.ExcludeFilter.textualDs;
...
public class ExcludeXFilterTest {
	...
	@Test
	public void whenFilteringOutStructures_structuresShouldNotBeVisited() {
	...
	@Test
	public void whenFilteringOutSpans_spansShouldNotBeVisited() {
		SaltUtil.traverse(documentStructure)
				.useStrategy(TraversalStrategy.TOP_DOWN_DEPTH_FIRST)
				.exclude(excludeSpans())
				.andCall(traversalHandler);
	...
	@Test
	public void whenFilteringOutTextualDs_textualDsShouldNotBeVisited() {
		SaltUtil.traverse(documentStructure)
				.useStrategy(TraversalStrategy.TOP_DOWN_DEPTH_FIRST)
				.exclude(textualDs())
				.andCall(traversalHandler);
	...
	@Test
	public void whenFilteringOutTextualDsAndTokens_textualDsAndTokensShouldNotBeVisited() {
		SaltUtil.traverse(documentStructure)
				.useStrategy(TraversalStrategy.TOP_DOWN_DEPTH_FIRST)
				.exclude(textualDs())
	...
	@Test
	public void whenFilteringForAllNodes_noNodeShouldBeVisited() {
		SaltUtil.traverse(documentStructure)
				.useStrategy(TraversalStrategy.BOTTOM_UP_DEPTH_FIRST)
				.exclude(structures())
				.exclude(textualDs())
	...
	// @Test
	// public void
	// whenFilteringForTextualDsAndTokens_onlyTextualDsAndTokensShouldBeVisited()
	// {
	// SaltUtil.traverse(documentStructure)
	// .startFrom(documentStructure.getLeafs())
	// .useStrategy(TraversalStrategy.BOTTOM_UP_DEPTH_FIRST)
