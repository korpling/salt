...
public class SDocumentTest {
	...
	/**
	 * Checks whether the id of the document graph's id is set when the
	 * document's graph is set
	 **/
	@Test
	...
	/**
	 * Checks whether the id of the document's graph id is set when the
	 * document's id is set
	 **/
	@Test
