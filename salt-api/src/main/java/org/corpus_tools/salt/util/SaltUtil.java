...
import org.corpus_tools.salt.util.traversal.TraverserBuilder_new;
...
public class SaltUtil {
	...
	public static TraverserBuilder_new traverse(SGraph graph) {
		// return new TraverserBuilder(graph);
		return new TraverserBuilder_new(graph);
	}
}
