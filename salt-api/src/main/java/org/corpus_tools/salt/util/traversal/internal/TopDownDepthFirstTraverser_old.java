...
public class TopDownDepthFirstTraverser_old extends Traverser {
	class NodeWithOrder {
		private final SNode node;
		private int order = 0;
		// TODO remove this
		private Iterator<SRelation<? extends SNode, ? extends SNode>> iterator;
		// TODO better name fromRelation make it final
	...
	public TopDownDepthFirstTraverser_old(List<? extends SNode> startNodes, TraversalStrategy strategy, String traverseId,
