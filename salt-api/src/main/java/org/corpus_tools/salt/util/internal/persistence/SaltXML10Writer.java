...
public class SaltXML10Writer implements SaltXML10Dictionary {
	 ...
	 * @throws XMLStreamException
	 */
	public void writeLayer(XMLStreamWriter xml, Layer<? extends Node, ?> layer, Map<SNode, Integer> nodePositions,
			Map<SRelation<?, ?>, Integer> relPositions) throws XMLStreamException {
		if (isPrettyPrint) {
			xml.writeCharacters("\n");
			xml.writeCharacters("\t");
		}
