...
public class SGraphTest {
	...
	private SGraph<SNode, SRelation<SNode, SNode>> fixture = null;

	public SGraph<SNode, SRelation<SNode, SNode>> getFixture() {
		return fixture;
	}

	public void setFixture(SGraph<SNode, SRelation<SNode, SNode>> fixture) {
