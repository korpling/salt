 ...
 *
 * <!-- begin-model-doc --> This class manages a set of Index objects, for
 * faster access on {@link GraphImpl} members. Such an {@link Index} object
 * indexes a single object (so called value) or a set of objects (so called
 * values) by using a unique key for indexing them. In case of the {@link Index}
 * object is of type {@link SimpleIndex}, each key has exactly one value in case
 * of the {@link Index} object is of type {@link ComplexIndex}, each key has a
 * list of values. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.hu_berlin.u.saltnpepper.salt.util.Index#getIndexes <em>Indexes
 * </em>}</li>
 * <li>{@link de.hu_berlin.u.saltnpepper.salt.util.Index#getNumOfIndexes <em>Num
 * Of Indexes</em>}</li>
 * </ul>
 * </p>
 */
public interface Index {
	...
	<K, V> List<V> getAll(String indexId, K key);
