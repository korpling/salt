...
public interface IdentifiableElement extends LabelableElement{
	...
	public String getId();
	/** 
	 * Creates a new {@link Identifier} object and sets its value to the passed id.
	...
	/** 
	 * Sets the {@link Identifier} label for this object. If this object alredy had an identifier, the old
