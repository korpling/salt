...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Slim Complex Index</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class SlimComplexIndexTest extends IdentifiableElementTest {
	...
	public static void main(String[] args) {
		TestRunner.run(SlimComplexIndexTest.class);
	}

	/**
	 * Constructs a new Slim Complex Index test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public SlimComplexIndexTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Slim Complex Index test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 */
	@Override
	protected SlimComplexIndex<String, String> getFixture() {
		return (SlimComplexIndex<String, String>)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(IndexFactory.eINSTANCE.createSlimComplexIndex());
	}
	...
	{
		this.basicTestEquals(IndexFactory.eINSTANCE.createSlimComplexIndex());
	}

} //SlimComplexIndexTest
