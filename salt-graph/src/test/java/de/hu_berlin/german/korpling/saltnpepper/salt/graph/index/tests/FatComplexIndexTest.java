 ...
 * @generated
 */
public class FatComplexIndexTest extends IdentifiableElementTest {
	...
	public static void main(String[] args) {
		TestRunner.run(FatComplexIndexTest.class);
	}

	/**
	 * Constructs a new Fat Complex Index test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public FatComplexIndexTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		setFixture(IndexFactory.eINSTANCE.createFatComplexIndex());
	}
	...
	public void testHasEntryOrId() throws Exception
	{
		...
		for (int i= 0; i< entries.length; i++)
		{
			...
			assertTrue("the index should have the id: " + entries[i][0], this.getFixture().hasKey(entries[i][0]));
		}
		...
		assertFalse("the index should not have the id: " + "not there", this.getFixture().hasKey("not there"));
	}
	...
	{
		this.basicTestEquals(IndexFactory.eINSTANCE.createFatComplexIndex());
	}
