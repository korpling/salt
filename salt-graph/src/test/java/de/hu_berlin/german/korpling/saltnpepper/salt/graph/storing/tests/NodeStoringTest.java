 ...
 * @generated
 */
public class NodeStoringTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(NodeStoringTest.class);
	}
	 ...
	 * @generated
	 */
	public NodeStoringTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		this.setFixture(GraphFactory.eINSTANCE.createNode());
	...
	{
		Node nodeNew= null;
		String tmpFileName= "_TMP/Node.graph";
		
		this.getFixture().setId("MyNode1");
		...
		{//save and reload
			...
			resource.load(null);
			nodeNew= (Node) resource.getContents().get(0);
		}
		{//check if both are equal
			assertEquals(this.getFixture(), nodeNew);
		}
	}
