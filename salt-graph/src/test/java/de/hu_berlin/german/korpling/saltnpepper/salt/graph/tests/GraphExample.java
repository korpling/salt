...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>graph</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphExample {
	...
	public static void main(String[] args) {
        ...
        if (args.length == 0)
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.graph"));
                Node root = GraphFactory.eINSTANCE.createNode();
