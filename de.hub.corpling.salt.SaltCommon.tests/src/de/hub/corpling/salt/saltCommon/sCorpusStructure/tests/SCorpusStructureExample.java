...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sCorpusStructure</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SCorpusStructureExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SCorpusStructurePackage.eNS_URI, 
			 SCorpusStructurePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.scorpusstructure"));
				SCorpusGraph root = SCorpusStructureFactory.eINSTANCE.createSCorpusGraph();
