 ...
 *
 */
public class SaltCoreException extends java.lang.RuntimeException
{
	/**
	...
	public SaltCoreException()
	{ super(); }
	
    public SaltCoreException(String s)
    { super(s); }
    
	public SaltCoreException(String s, Throwable ex)
	{super(s, ex); }
}
