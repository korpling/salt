...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SSentence Annotation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
...
public class SSentenceAnnotationImpl extends SAnnotationImpl implements SSentenceAnnotation {
	 ...
	 * <!-- end-user-doc -->
	 */
	protected SSentenceAnnotationImpl() {
		super();
		init();
	}
	...
	private void init()
	{
		...
		this.basicSetSName();
		//initializing value
		super.setSValue(SALT_SEMANTIC_NAMES.TEXT_UNIT_SENTENCE.toString());
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	protected EClass eStaticClass() {
		return SaltSemanticsPackage.Literals.SSENTENCE_ANNOTATION;
	}
	 ...
	 * <!-- end-user-doc -->
	 */
	public Boolean isSSentenceAnnotation(SAnnotation sAnnotation) 
	{
